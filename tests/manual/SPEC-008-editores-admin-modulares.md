...
Los dos primeros casos fueron marcados como superados por el usuario el
2026-09-21; no se reprodujeron con una sesión administrativa desde este entorno.

- [X] **TEST-801 / REQ-801:** filtrar productos, abrir uno existente, cambiar un campo, guardar y comprobar que persiste tras recargar. Crear un borrador, duplicarlo y borrarlo; verificar confirmaciones y errores.
- [X] **TEST-801 / REQ-801:** en el formulario, elegir y cancelar una foto, reordenar fotos y características, y guardar una foto válida en R2.
