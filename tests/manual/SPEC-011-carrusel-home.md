...
- [ ] **TEST-M1101 · REQ-1101:** abrir `/` a 1366 px y a 1904 px de ancho. En una sección con siete o más productos se ven seis tarjetas completas sin mover el carrusel; no asoma ninguna parte de la séptima. Avanzar y retroceder con las flechas: cada posición estable muestra como máximo seis. Los márgenes exteriores quedan equilibrados. Comprobar también con scrollbar vertical visible.
