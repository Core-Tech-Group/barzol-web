/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 296b6afdc080b81533a14ce774e9a0cb)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 global_fetch_strictly_public
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	ASSETS: Fetcher;
	BARZOL_SUPABASE_URL: string;
	BARZOL_SUPABASE_ANON_KEY: string;
	BARZOL_SUPABASE_SERVICE_ROLE_KEY: string;
	BARZOL_R2_ACCOUNT_ID: string;
	BARZOL_R2_ACCESS_KEY: string;
	BARZOL_R2_SECRET_KEY: string;
	BARZOL_R2_BUCKET_NAME: string;
	BARZOL_R2_PUBLIC_URL: string;
}
