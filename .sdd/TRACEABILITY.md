...
> **Última actualización:** 2026-09-21 (SPEC-004 SQL aplicado; SPEC-011 carrusel)
...
| [SPEC-004](specs/SPEC-004-orden-productos.md) · Orden manual de productos | **APROBADA** | ✅ código y SQL aplicado; lectura remota y rechazo anónimo verificados | ✅ pruebas unitarias e interacción; ⏳ escritura admin y visita manual |
| [SPEC-011](specs/SPEC-011-carrusel-home-escritorio.md) · Seis tarjetas en inicio | **APROBADA** | ✅ ajuste de anchura del carrusel del inicio | ⏳ matriz visual manual; typecheck/build/CI |
...
| SPEC-004 | 401–418 | **18 / 18 citados** | probar escritura con sesión admin y reflejo público |
| SPEC-011 | 1101–1103 | **3 / 3 citados** | inspección visual en navegador |
